...
[![CI](https://github.com/YOUR_USERNAME/ml-platform/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/ml-platform/actions/workflows/ci.yml)
![Python](https://img.shields.io/badge/python-3.12-blue)
![Tests](https://img.shields.io/badge/tests-11%20passing-brightgreen)
![License](https://img.shields.io/badge/license-MIT-lightgrey)

> Replace `YOUR_USERNAME` above with your GitHub username once pushed, so the badge renders live.
